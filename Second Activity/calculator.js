...
const loan = () => {
  let lamount = parseFloat(document.getElementById("loanAmount").value);
  let months = parseFloat(document.getElementById("month").value);
  let computeAmount=document.getElementById("computeAmount")
